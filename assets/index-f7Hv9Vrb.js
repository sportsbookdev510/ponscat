...
function VS({ token: e }) {
  ...
  return d.jsxs("section", {
    ...
    children: [
      d.jsx("div", {
        className:
          "blob w-[32rem] h-[32rem] -left-40 top-10 bg-glass-sage animate-drift-blob opacity-50",
      }),
      d.jsx("div", {
        className:
          "blob w-[28rem] h-[28rem] -right-32 bottom-10 bg-glass-mint animate-drift-blob opacity-40",
      }),
      d.jsxs("div", {
        className: "relative mx-auto max-w-6xl px-4",
        children: [
          d.jsx(eo, {
            kicker: "Live Feed",
            title: "LIVE DISTRIBUTIONS",
            color: "text-glass-deep",
          }),
          d.jsx(ff, {
            className: "panel-green p-5 md:p-6 mb-6 text-white overflow-hidden",
            children: d.jsxs("div", {
              className:
              ...
              children: [
                d.jsxs("div", {
                  ...
                  children: [
                    ...
                    d.jsxs("div", {
                      className:
                        "comic-title text-5xl md:text-6xl tabular-nums leading-none",
                      children: [f, ":", g],
                    }),
                  ],
                }),
                d.jsxs("div", {
                  ...
                  children: [
                    d.jsxs("div", {
                      className:
                        "flex justify-between font-display tracking-wide text-sm mb-1",
                      children: [
                        d.jsx("span", { children: "Filling the reward pool…" }),
                        d.jsxs("span", { children: [Math.floor(h), "%"] }),
                      ],
                    }),
                    d.jsx("div", {
                      className:
                        "h-7 w-full bg-white/25 border border-white/50 rounded-full overflow-hidden",
                      children: d.jsx(O.div, {
                        className:
                          "h-full bg-gradient-to-r from-glass-sage via-glass-green to-glass-deep",
                        animate: { width: `${h}%` },
                        transition: { ease: "linear", duration: 0.9 },
                        children: d.jsx("div", { className: "h-full w-full" }),
                      }),
                    }),
                    d.jsx("p", {
                      className:
                        "font-comic font-bold text-white/80 text-sm mt-1",
                      children:
                        "$PONS distributes every 5 minutes · sent automatically to all holders with 100,000+ PONSCAT",
                    }),
                  ],
                }),
              ],
          ...
          d.jsxs("div", {
            className:
              "flex flex-col sm:flex-row gap-3 mb-4 items-stretch sm:items-center",
            children: [
              d.jsxs("div", {
                ...
                children: [
                  d.jsx("span", {
                    className:
                      "absolute left-3 top-1/2 -translate-y-1/2 text-xl",
                    children: "🔍",
                  }),
                  d.jsx("input", {
                    value: a,
                    ...
                    onFocus: () => t("click"),
                    placeholder: "Search a holder's wallet or TX…",
                    className:
                      "glass w-full font-comic font-bold pl-11 pr-4 py-3 rounded-2xl shadow-glass-sm focus:outline-none focus:shadow-glass focus:-translate-y-0.5 transition-all placeholder:text-ink/40",
                  }),
                ],
              }),
              d.jsxs("div", {
                className:
                  "chip justify-center py-2.5 bg-glass-green/80 text-white border-white/50",
                children: [
                  d.jsx("span", {
                    className:
                      "w-2.5 h-2.5 rounded-full bg-white animate-flash",
                  }),
                  c.length,
                  " drops shown",
                ],
          ...
          d.jsx(ff, {
            ...
            children: d.jsx("div", {
              className:
                "glass-scroll overflow-y-auto max-h-[60vh] md:max-h-[560px] p-4 md:p-5 bg-white/20",
              children: s
                ? d.jsx("div", {
                    className:
                ...
                ? d.jsx("div", {
                    className:
                      "px-4 py-16 text-center font-display text-2xl text-ink/50",
                    children: "🔍 No holders match that search",
                  })
                : d.jsx("div", {
                    className:
                      "grid gap-4 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4",
          ...
          d.jsxs("p", {
            className:
              "text-center font-comic font-bold text-ink/60 text-sm mt-4",
            children: [
              "Feed updates live · click any wallet or TX to inspect it on ",
              (e == null ? void 0 : e.chain) || "chain",
              " explorer",
            ],
          }),
        ],
